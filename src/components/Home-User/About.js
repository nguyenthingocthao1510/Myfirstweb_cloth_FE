    ...
    <div>
      ...
      <div className="container container--type-4">
        ...
        <div className="about-page__description">
          ...
          together in the UK. The inspiration is drawn from nature, pastel
          colors, and daily activities. Durotan’s items always possess a basic
          yet timeless look, easily complementing any style.
        </div>
          ...
          <div className="container container--type-4">
            ...
            <div className="row">
                ...
                <div className="about-company__description">
                  <p>
                    <span>
                      ...
                      responsibility, our brand was born. Our passion for the
                      environment and unique design brought our vision, and
                      products, to life.
                    </span>
                  </p>
                  <p>
              ...
              <div className="col-lg-6 about-company__item">
                ...
                <div className="about-company__description">
                  <p>
                    What that starts with, then, is a design which meets the
                    needs not only of today and tomorrow, but the tomorrow after
                    tomorrow, too, and of any number of tomorrows after that. It
                    is a design which has designs to be, above all, pleasing to
                    wear and satisfying to use, and, all the while, to go about
                    its business in a way best described as unassuming.
                  </p>
                  <p>
                    Absolutely no hassle. No matter what you spill on it -
                    coffee, oil, cranberry juice, nail polish, you can easily
                    wipe it clean with just soap and water.
                  </p>
                  <p>From Durian with Love,</p>
                  <p>
